...
1. [Building and analyzing metacells with SuperCell](./vignettes/SuperCell.Rmd)
2. [RNA velocity applied to SuperCell object](./vignettes/RNAvelocity_for_SuperCell.Rmd)
